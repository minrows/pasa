...
<style type="text/css">
    .service-box.box1 {
        background: url(<?php echo e(asset('image/check/servicebox1.jpg')); ?>);
        background-size: cover;
    }
    .service-box.box2 {
        background: url(<?php echo e(asset('image/check/servicebox2.jpg')); ?>) no-repeat 0% 0%;
        background-size: cover;
    }
    .service-box.box3 {
        background: url(<?php echo e(asset('image/check/servicebox3.jpg')); ?>) no-repeat 0% 0%;
        background-size: cover;
    }
    .panel-widget-style.img {
        background-image: url(<?php echo e(asset('image/check/blog_03.jpg')); ?>);
    }
...
<head>
		...
		<!-- FAVICON
			========================================================================= -->
		<link rel="icon" href="<?php echo e(asset('image/favicon.png')); ?>" />
		<!-- GOOGLE FONTS
			========================================================================= -->
		
		<!-- STYLESHEETS
			========================================================================= -->
		<link rel='stylesheet' href="<?php echo e(asset('css/home_css/bootstrap.css')); ?>" type='text/css' />
		<link rel='stylesheet' href="<?php echo e(asset('css/home_css/font-awesome.css')); ?>" type='text/css' />
		<link rel='stylesheet' href="<?php echo e(asset('css/home_css/owl.carousel.css')); ?>" type='text/css' />
		<link rel='stylesheet' href="<?php echo e(asset('css/home_css/lightbox.css')); ?>" type='text/css' />
		<link rel='stylesheet' href="<?php echo e(asset('css/home_css/jquery.mmenu.css')); ?>" type='text/css' />
		<link rel='stylesheet' href="<?php echo e(asset('css/home_css/animate.css')); ?>" type='text/css' />
		<link rel='stylesheet' href="<?php echo e(asset('css/home_css/fx.css')); ?>" type='text/css' />
		<link rel='stylesheet' href="<?php echo e(asset('css/home_css/style.css')); ?>" type='text/css' />
	</head>
	<body id="home">
		...
		<div id="page" class="site sticky_header">
			...
			<header id="masthead" class="masthead-corporate site-header  clearfix" role="banner">
				...
				<div id="menu" class="clearfix dark menu-class">
					<div class="container">
						<div id="logo">
							<a href="/" rel="home">
								<img src="<?php echo e(asset('image/check/logo-1.png')); ?>" alt="Consulting" />
							</a>
						</div>
			...
			<section id="slider-main" class="carousel slide" data-ride="carousel">
				<div class="carousel-inner">
					...
					<div class="item <?php if($i==1): ?> <?php echo e(' active'); ?> <?php endif; ?>" id="particles-js" style="background-image:url(<?php echo e(asset('/image/'.$carousel->img)); ?>); ">
			...
			<div id="content" class="site-content">
				...
				<div class="container-fluid spadding" id="about-us">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h1 class="header h1"><?php echo e($about->title); ?></h1>
									...
									<div class="gallery-full column-equal col-sm-6 col-md-3 fx-start" data-animation="bounceIn">
										<div class="thumbnail fx-hover">
											...
											<div class="fx-hover-icon">
												<a class="icon-medium icon-main" href="<?php echo e(asset('image/check/g1.jpg')); ?>" data-lightbox="gallery" data-title="Gallery One"><i class="fa fa-camera"></i></a>
											</div>
											<img src="<?php echo e(asset('image/check/g1.jpg')); ?>" width="400" height="400" alt="Gallery One" />
										</div>
									</div>
									<div class="gallery-full column-equal col-sm-6 col-md-3 fx-start" data-animation="bounceIn">
										<div class="thumbnail fx-hover">
											...
											<div class="fx-hover-icon">
												<a class="icon-medium icon-main" href="<?php echo e(asset('image/check/g2.jpg')); ?>" data-lightbox="gallery" data-title="Gallery Two"><i class="fa fa-camera"></i></a>
											</div>
											<img src="<?php echo e(asset('image/check/g2.jpg')); ?>" width="400" height="400" alt="Gallery Two" />
										</div>
									</div>
									<div class="gallery-full column-equal col-sm-6 col-md-3 fx-start" data-animation="bounceIn">
										<div class="thumbnail fx-hover">
											...
											<div class="fx-hover-icon">
												<a class="icon-medium icon-main" href="<?php echo e(asset('image/check/g3.jpg')); ?>" data-lightbox="gallery" data-title="Gallery Three"><i class="fa fa-camera"></i></a>
											</div>
											<img src="<?php echo e(asset('image/check/g3.jpg')); ?>" width="400" height="400" alt="Gallery Three" />
										</div>
									</div>
									<div class="gallery-full column-equal col-sm-6 col-md-3 fx-start" data-animation="bounceIn">
										<div class="thumbnail fx-hover">
											...
											<div class="fx-hover-icon">
												<a class="icon-medium icon-main" href="<?php echo e(asset('image/check/g4.jpg')); ?>" data-lightbox="gallery" data-title="Gallery Four"><i class="fa fa-camera"></i></a>
											</div>
											<img src="<?php echo e(asset('image/check/g4.jpg')); ?>" width="400" height="400" alt="Gallery Four" />
										</div>
									</div>
									<div class="gallery-full column-equal col-sm-6 col-md-3 fx-start" data-animation="bounceIn">
										<div class="thumbnail fx-hover">
											...
											<div class="fx-hover-icon">
												<a class="icon-medium icon-main" href="<?php echo e(asset('image/check/g5.jpg')); ?>" data-lightbox="gallery" data-title="Gallery Five"><i class="fa fa-camera"></i></a>
											</div>
											<img src="<?php echo e(asset('image/check/g5.jpg')); ?>" width="400" height="400" alt="Gallery Five" />
										</div>
									</div>
									<div class="gallery-full column-equal col-sm-6 col-md-3 fx-start" data-animation="bounceIn">
										<div class="thumbnail fx-hover">
											...
											<div class="fx-hover-icon">
												<a class="icon-medium icon-main" href="<?php echo e(asset('image/check/g6.jpg')); ?>" data-lightbox="gallery" data-title="Gallery Six"><i class="fa fa-camera"></i></a>
											</div>
											<img src="<?php echo e(asset('image/check/g6.jpg')); ?>" width="400" height="400" alt="Gallery Six" />
										</div>
									</div>
									<div class="gallery-full column-equal col-sm-6 col-md-3 fx-start" data-animation="bounceIn">
										<div class="thumbnail fx-hover">
											...
											<div class="fx-hover-icon">
												<a class="icon-medium icon-main" href="<?php echo e(asset('image/check/g7.jpg')); ?>" data-lightbox="gallery" data-title="Gallery Seven"><i class="fa fa-camera"></i></a>
											</div>
											<img src="<?php echo e(asset('image/check/g7.jpg')); ?>" width="400" height="400" alt="Gallery Seven" />
										</div>
									</div>
									<div class="gallery-full column-equal col-sm-6 col-md-3 fx-start" data-animation="bounceIn">
										<div class="thumbnail fx-hover">
											...
											<div class="fx-hover-icon">
												<a class="icon-medium icon-main" href="<?php echo e(asset('image/check/g8.jpg')); ?>" data-lightbox="gallery" data-title="Gallery Eight"><i class="fa fa-camera"></i></a>
											</div>
											<img src="<?php echo e(asset('image/check/g8.jpg')); ?>" width="400" height="400" alt="Gallery Eight" />
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-7 center-block">
								...
								<div class="testimonials-slider owl-carousel owl-theme">
									...
									<div class="item">
										<blockquote>
											<figure>
												<img src="<?php echo e(asset('image/check/user1.jpg')); ?>" alt="user" class="img-circle">
											</figure>
									...
									<div class="item">
										<blockquote>
											<figure>
												<img src="<?php echo e(asset('image/check/user2.jpg')); ?>" alt="user" class="img-circle">
											</figure>
									...
									<div class="item">
										<blockquote>
											<figure>
												<img src="<?php echo e(asset('image/check/user3.jpg')); ?>" alt="user" class="img-circle">
											</figure>
						...
						<div class="row">
							<aside class="widget aio-widget-text col-sm-6 col-md-3 ">
								<div class="text clearfix">
									<img src="<?php echo e(asset('image/check/logo-footer.png')); ?>" width="160" height="48" />
							...
							<aside class="widget aio-widget-blogs col-sm-6 col-md-3 ">
								...
								<div class="blog-widget">
									<div class="thumbnail">
										<img src="<?php echo e(asset('image/check/blog1.jpg')); ?>" width="400" height="400" alt="Board Of Director" />
									</div>
								...
								<div class="blog-widget">
									<div class="thumbnail">
										<img src="<?php echo e(asset('image/check/blog2.jpg')); ?>" width="400" height="400" alt="New Office Lobby" />
									</div>
							...
							<aside class="widget aio-widget-testimonials col-sm-6 col-md-3 ">
								...
								<div class="testimonial-grid column-equal">
									...
									<div class="testimonial-foot clearfix">
										<div class="thumbnail">
											<img src="<?php echo e(asset('image/check/review1.jpg')); ?>" width="100" height="100" alt="Miranda Hazard Footer" />
										</div>
							...
							<aside class="widget aio-widget-testimonials col-sm-6 col-md-3 ">
								...
								<div class="testimonial-grid column-equal">
									...
									<div class="testimonial-foot clearfix">
										<div class="thumbnail">
											<img src="<?php echo e(asset('image/check/review2.jpg')); ?>" width="100" height="100" alt="Miranda Hazard Footer" />
										</div>
		...
		<script type='text/javascript' src="<?php echo e(asset('js/home_js/jquery-3.1.1.min.js')); ?>"></script>
		<script type='text/javascript' src="<?php echo e(asset('js/home_js/bootstrap.js')); ?>"></script>
		<script type='text/javascript' src="<?php echo e(asset('js/home_js/owl.carousel.js')); ?>"></script>
		<script type='text/javascript' src="<?php echo e(asset('js/home_js/lightbox.js')); ?>"></script>
		<script type='text/javascript' src="<?php echo e(asset('js/home_js/particles.min.js')); ?>"></script>
		<script type='text/javascript' src="<?php echo e(asset('js/home_js/jquery.easing.js')); ?>"></script>
		<script type='text/javascript' src="<?php echo e(asset('js/home_js/masonry.js')); ?>"></script>
		<script type='text/javascript' src="<?php echo e(asset('js/home_js/jquery.mmenu.js')); ?>"></script>
		<script type='text/javascript' src="<?php echo e(asset('js/home_js/app.js')); ?>"></script>
		<script type='text/javascript' src="<?php echo e(asset('js/home_js/scripts.js')); ?>"></script>
