    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <?php echo Form::text('uname', null, array('placeholder' => 'User Name','class' => 'form-control')); ?>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <?php echo Form::text('phn', null, array('placeholder' => 'Phone Number','class' => 'form-control')); ?>
