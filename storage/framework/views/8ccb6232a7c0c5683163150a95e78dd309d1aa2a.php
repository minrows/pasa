        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" name="add_new" id="add_new" action="<?php echo e('/pasa_admin/add_gallery'); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('layouts.admin_app',['select' => 'gallery'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>